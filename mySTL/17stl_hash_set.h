 ...
 *hash_set实现
 *
 *hash_set使用hashtable作为底层容器，hashtable提供了所有hash_set需要的操作
 *hash_set使用hashtable的insert_unique来插入元素，hast_multiset使用 insert_equal
 */

#ifndef _STL_HASH_SET_H_
#define _STL_HASH_SET_H_
